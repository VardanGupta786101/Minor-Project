# Generated by Django 2.2.4 on 2021-03-28 09:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='college.Category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='college.Product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='college.Cart')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.PositiveIntegerField()),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='college.Cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='college.Product')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='college.Customer'),
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
